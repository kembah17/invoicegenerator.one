...
export default function EstimateGenerator() {
  ...
  const handleDownload = useCallback(async () => {
    setDownloading(true);
    try {
      await generatePDF("estimate-preview", `estimate-${data.quoteNumber}`);
    } catch (err) {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 24 }} className="lg:!grid-cols-[1fr_1fr]">
      ...
      <div className="no-print">
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              ...
              <select value={data.template} onChange={e => updateField("template", e.target.value as EstimateTemplate)} style={inputStyle} aria-label="Estimate template">
        ...
        {/* Client Details */}
        <div style={sectionStyle}>
          <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 12, color: "var(--color-text)" }}>Client Details</h3>
          <div style={{ display: "grid", gap: 10 }}>
            <div>
        ...
        {/* Quote Details */}
        <div style={sectionStyle}>
          <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 12, color: "var(--color-text)" }}>Quote Details</h3>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
            <div>
              <label style={labelStyle}>Quote #</label>
              <input style={inputStyle} value={data.quoteNumber} onChange={e => updateField("quoteNumber", e.target.value)} />
            </div>
            <div>
            ...
            <div>
              ...
              <input style={inputStyle} type="date" value={data.validUntil} onChange={e => updateField("validUntil", e.target.value)} />
            </div>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          {data.items.map((item, idx) => (
            <div key={item.id} style={{ display: "grid", gridTemplateColumns: "1fr 70px 90px 90px 32px", gap: 8, marginBottom: 8, alignItems: "end" }}>
              ...
              <div>
                {idx === 0 && <label style={labelStyle}>Rate</label>}
        ...
        {/* Terms */}
        <div style={sectionStyle}>
          <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 12, color: "var(--color-text)" }}>Terms & Conditions</h3>
          <textarea
